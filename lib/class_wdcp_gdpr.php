...
class Wdcp_Gdpr {
	...
	public function get_policy_content() {
		return '' .
			...
			'<p>' . __( 'This site might be using third parties to assert your identity (with your explicit consent) before leaving a comment. These services include Facebook, Google and Twitter.', 'wdcp' ) . '</p>' .
